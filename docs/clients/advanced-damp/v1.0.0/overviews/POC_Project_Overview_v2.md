...
**Supersedes for delivery status:** `POC_Project_Overview.md` (v1 — original proposal)  
**Client:** Advanced Damp Ltd  
**Product type:** Local production estimating platform (evolved from POC)  
**Version:** 1.0.0-local-prod  
**Brand reference:** Local synthetic demo brand (see `docs/guides/UI_UX_DESIGN_SYSTEM.md`)  
**Currency / market:** GBP · United Kingdom  

> **Delivery update (Aug 2026):** The POC has been extended into a **local production foundation** (Phases A–G). See `docs/ops/IMPLEMENTATION_STATUS.md` and `docs/ops/CLIENT_HANDOFF.md` for the current handoff pack. Commercial go-live still requires Advanced Damp live rates, historical job validation, and sign-off.
...
Full rules are documented in `docs/guides/UI_UX_DESIGN_SYSTEM.md`.
...
**Not yet commercially production-ready until:** real rates loaded, 5–10 historical jobs validated, passwords/JWT secured, client PDF sign-off (`docs/ops/RELEASE_CHECKLIST.md`).
...
Handoff documentation: `docs/ops/CLIENT_HANDOFF.md`
...
| Related v1 | `POC_Project_Overview.md` (original proposal) |
| UI rules | `docs/guides/UI_UX_DESIGN_SYSTEM.md` |
