...
See `docs/ops/VERCEL_DEPLOYMENT.md`. Note: SQLite on Vercel is ephemeral; Postgres recommended for lasting cloud data.
...
| Document | Audience |
|---|---|
| `docs/ops/CLIENT_HANDOFF.md` | Client / owner — start here |
| `docs/guides/USER_GUIDE.md` | Surveyors and office staff |
| `docs/guides/ADMIN_GUIDE.md` | Owner / admin |
| `docs/ops/RELEASE_CHECKLIST.md` | Go-live sign-off |
| `docs/guides/ACCEPTANCE_TEST_SCENARIOS.md` | QA / UAT (scenarios A–M) |
| `docs/guides/HISTORICAL_JOB_VALIDATION.md` | Commercial sign-off worksheet |
| `docs/guides/RATE_IMPORT.md` | Bulk rate CSV workflow |
| `docs/ops/SECURITY.md` | IT security review |
| `docs/guides/API_REFERENCE.md` | Search & export HTTP API |
| `docs/ops/VERCEL_DEPLOYMENT.md` | Cloud deployment |
| `docs/ops/CHANGELOG.md` | Feature history |
...
| **Client handoff** | `docs/ops/CLIENT_HANDOFF.md` |
| **API documentation** | `http://127.0.0.1:8000/docs` (when running locally) |
| **Live demo (Vercel)** | Configure per `docs/ops/VERCEL_DEPLOYMENT.md` |
