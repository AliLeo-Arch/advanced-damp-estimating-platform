...
```text
docs/clients/advanced-damp/v1.0.0/demos/poc/
...
**Post-POC production screenshots** (login, dashboard table, editor UX) are in [`../production/README.md`](../production/README.md).
