...
Use your demo email and password. Demo accounts are listed in `../ops/LOCAL_PRODUCTION_ASSUMPTIONS.md` for local testing.
...
Contact your office administrator or commercial manager for rates, margins, and quotation wording changes. See also `../ops/CHANGELOG.md` for recent features.
