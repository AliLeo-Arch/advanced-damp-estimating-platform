...
See `../ops/LOCAL_PRODUCTION_ASSUMPTIONS.md` for demo credentials.
...
Staff can search and paginate estimates on the dashboard (see `./USER_GUIDE.md`).
...
Follow `../ops/RELEASE_CHECKLIST.md` before calling the deployment production-ready.  
Recent feature list: `../ops/CHANGELOG.md`.
