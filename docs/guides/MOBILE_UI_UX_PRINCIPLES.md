...
**Brand source:** Local synthetic demo brand + `./UI_UX_DESIGN_SYSTEM.md`  
...
| Document | Role |
|---|---|
| `./UI_UX_DESIGN_SYSTEM.md` | Overall brand + desktop/app principles |
| `./MOBILE_UI_UX_PRINCIPLES.md` | **This file** — phone/tablet behaviour |
