...
- [ ] `../guides/USER_GUIDE.md` provided to staff
- [ ] `../guides/ADMIN_GUIDE.md` provided to owner/admin
- [ ] `./CHANGELOG.md` reviewed for recent features
- [ ] `./LOCAL_PRODUCTION_ASSUMPTIONS.md` reviewed and updated
...
Expected: all tests pass (**40** on seed data as of September 2026 — see `./CHANGELOG.md`).
