...
**Handoff entry point:** `./CLIENT_HANDOFF.md`  
...
See `./SCRIPTS_REFERENCE.md`. Key scripts:
...
| Doc | Audience |
|---|---|
| `./CLIENT_HANDOFF.md` | **Start here** — client / owner |
| `./CHANGELOG.md` | What changed recently |
| `../guides/API_REFERENCE.md` | Search / export HTTP API |
| `../guides/USER_GUIDE.md` | Surveyors, office |
| `../guides/ADMIN_GUIDE.md` | Owner, admin |
| `./SCRIPTS_REFERENCE.md` | IT / developer |
| `../guides/RATE_IMPORT.md` | Rate CSV workflow |
| `./RELEASE_CHECKLIST.md` | Go-live |
| `../guides/ACCEPTANCE_TEST_SCENARIOS.md` | QA / UAT |
| `../guides/HISTORICAL_JOB_VALIDATION.md` | Commercial sign-off |
| `./SECURITY.md` | IT / admin |
| `./LOCAL_PRODUCTION_ASSUMPTIONS.md` | Assumed defaults |
| `../guides/MOBILE_UI_UX_PRINCIPLES.md` | Mobile UX |
...
5. Complete `./RELEASE_CHECKLIST.md` and sign off
